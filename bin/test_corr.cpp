...
int main(int argc, char **argv)
{
  ...
  char filename_out_proton[257] = "/home/khadjiyiannakou/qudaQKXTM_package/bin/test/corr_proton";
  char filename_out_neutron[257] = "/home/khadjiyiannakou/qudaQKXTM_package/bin/test/corr_neutron";
  ...
  double *pointer_corr = corr->H_elem();
  ...
  for(int iv = 0 ; iv < V ; iv++)
	...
	fprintf(ptr_out_proton,"%d %d %d %+e %+e\n",iv,gamma,gamma1,pointer_corr[iv*4*4*2 + gamma*4*2 + gamma1*2 + 0] , pointer_corr[iv*4*4*2 + gamma*4*2 + gamma1*2 + 1]);
    }
