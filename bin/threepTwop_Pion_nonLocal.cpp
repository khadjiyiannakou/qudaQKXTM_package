...
int main(int argc, char **argv)
{
  ...
  ThpTwp_Pion_nonLocal(gauge,gauge_APE,&inv_param,&gauge_param,info.sourcePosition,t_sink,testParticle,twop_filename,threep_filename, Nmom , momElem, direction, NmomSink, momSink);
