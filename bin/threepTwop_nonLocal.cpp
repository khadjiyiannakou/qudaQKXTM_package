...
extern double kappa;
extern int nsmearHYP;
extern double omega1HYP;
extern double omega2HYP;
extern int momP_fixed;
...
int main(int argc, char **argv)
{
  ...
  info.nsmearHYP = nsmearHYP;
  info.omega1HYP = omega1HYP;
  info.omega2HYP = omega2HYP;
  int Nmom;
  ...
  */
  ...
  momSink[0][0] = 0;
  momSink[0][1] = 0;
  momSink[0][2] = momP_fixed;
  int direction = 2;

  ThpTwp_nonLocal(gauge,gauge_APE,&inv_param,&gauge_param,info.sourcePosition,t_sink,testParticle,twop_filename,threep_filename, Nmom , momElem, direction, NmomSink, momSink);
