...
int main(int argc, char **argv)
{
  ...
  */
  ...
  ThpTwp_stoch_Pion_WilsonLinks(gauge,gauge_APE,&inv_param,&gauge_param,info.sourcePosition,t_sink,twop_filename,threep_filename, Nmom , momElem, seed, Nstoch, NmomSink,momSink);
