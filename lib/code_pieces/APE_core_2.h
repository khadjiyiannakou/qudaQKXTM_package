...
if(c_dimBreak[1] == true && (y_id == 0)){
  ...
  READPROPGAUGE(GP,propagatorTexAPE,0,1,pointMinus[1],c_surface[1]);
#else
  DIRECTREADPROP(GP,prop,0,1,pointMinus[1],c_surface[1]);
#endif
 }
 else{
#ifdef _PROPAGATOR_APE_TEX
 READPROPGAUGE(GP,propagatorTexAPE,0,1,pointMinus[1],c_stride);
#else
 DIRECTREADPROP(GP,prop,0,1,pointMinus[1],c_stride);
#endif
 }
...
if(sid == 0){
  ...
  for(int c1 = 0 ; c1 < 3 ; c1++)
    for(int c2 = 0 ; c2 < 3 ; c2++)
      cuPrintf("%e %e\n",out[0*c_nColor*c_nColor*c_stride + c1*c_nColor*c_stride + c2*c_stride + sid].x , out[0*c_nColor*c_nColor*c_stride + c1*c_nColor*c_stride + c2*c_stride + sid].y);
      }
*/
/////////////// mu = 0 , nu =2
...
#ifdef _PROPAGATOR_APE_TEX
  READPROPGAUGE(GP,propagatorTexAPE,0,2,pointMinus[2],c_surface[2]);
#else
  DIRECTREADPROP(GP,prop,0,2,pointMinus[2],c_surface[2]);
#endif
 }
 else{
#ifdef _PROPAGATOR_APE_TEX
   READPROPGAUGE(GP,propagatorTexAPE,0,2,pointMinus[2],c_stride);
#else
   DIRECTREADPROP(GP,prop,0,2,pointMinus[2],c_stride);
#endif
 }
...
#ifdef _PROPAGATOR_APE_TEX
  READPROPGAUGE(GP,propagatorTexAPE,1,0,pointMinus[0],c_surface[0]);
#else
  DIRECTREADPROP(GP,prop,1,0,pointMinus[0],c_surface[0]);
#endif
 }
 else{
#ifdef _PROPAGATOR_APE_TEX
   READPROPGAUGE(GP,propagatorTexAPE,1,0,pointMinus[0],c_stride);
#else
   DIRECTREADPROP(GP,prop,1,0,pointMinus[0],c_stride);
#endif
 }
...
if(c_dimBreak[2] == true && (z_id == 0)){
#ifdef _PROPAGATOR_APE_TEX
  READPROPGAUGE(GP,propagatorTexAPE,1,2,pointMinus[2],c_surface[2]);
#else
  DIRECTREADPROP(GP,prop,1,2,pointMinus[2],c_surface[2]);
#endif
 }
 else{
#ifdef _PROPAGATOR_APE_TEX
   READPROPGAUGE(GP,propagatorTexAPE,1,2,pointMinus[2],c_stride);
#else
   DIRECTREADPROP(GP,prop,1,2,pointMinus[2],c_stride);
#endif
 }
...
if(c_dimBreak[0] == true && (x_id == 0)){
#ifdef _PROPAGATOR_APE_TEX
  READPROPGAUGE(GP,propagatorTexAPE,2,0,pointMinus[0],c_surface[0]);
#else
  DIRECTREADPROP(GP,prop,2,0,pointMinus[0],c_surface[0]);
#endif
 }
 else{
#ifdef _PROPAGATOR_APE_TEX
   READPROPGAUGE(GP,propagatorTexAPE,2,0,pointMinus[0],c_stride);
#else
   DIRECTREADPROP(GP,prop,2,0,pointMinus[0],c_stride);
#endif
 }
...
if(c_dimBreak[1] == true && (y_id == 0)){
#ifdef _PROPAGATOR_APE_TEX
  READPROPGAUGE(GP,propagatorTexAPE,2,1,pointMinus[1],c_surface[1]);
#else
  DIRECTREADPROP(GP,prop,2,1,pointMinus[1],c_surface[1]);
#endif
 }
 else{
#ifdef _PROPAGATOR_APE_TEX
   READPROPGAUGE(GP,propagatorTexAPE,2,1,pointMinus[1],c_stride);
#else
   DIRECTREADPROP(GP,prop,2,1,pointMinus[1],c_stride);
#endif
 }
...
out[0*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 0*c_stride + sid] = c_alphaAPE * out[0*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 0*c_stride + sid] + G1_0;
out[0*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 1*c_stride + sid] = c_alphaAPE * out[0*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 1*c_stride + sid] + G1_1;
out[0*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 2*c_stride + sid] = c_alphaAPE * out[0*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 2*c_stride + sid] + G1_2;
out[0*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 0*c_stride + sid] = c_alphaAPE * out[0*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 0*c_stride + sid] + G1_3;
out[0*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 1*c_stride + sid] = c_alphaAPE * out[0*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 1*c_stride + sid] + G1_4;
out[0*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 2*c_stride + sid] = c_alphaAPE * out[0*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 2*c_stride + sid] + G1_5;
out[0*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 0*c_stride + sid] = c_alphaAPE * out[0*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 0*c_stride + sid] + G1_6;
out[0*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 1*c_stride + sid] = c_alphaAPE * out[0*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 1*c_stride + sid] + G1_7;
out[0*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 2*c_stride + sid] = c_alphaAPE * out[0*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 2*c_stride + sid] + G1_8;
////////////// mu = 1 
READGAUGE(G1,gaugeTexAPE,1,sid,c_stride);
out[1*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 0*c_stride + sid] = c_alphaAPE * out[1*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 0*c_stride + sid] + G1_0;
out[1*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 1*c_stride + sid] = c_alphaAPE * out[1*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 1*c_stride + sid] + G1_1;
out[1*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 2*c_stride + sid] = c_alphaAPE * out[1*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 2*c_stride + sid] + G1_2;
out[1*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 0*c_stride + sid] = c_alphaAPE * out[1*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 0*c_stride + sid] + G1_3;
out[1*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 1*c_stride + sid] = c_alphaAPE * out[1*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 1*c_stride + sid] + G1_4;
out[1*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 2*c_stride + sid] = c_alphaAPE * out[1*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 2*c_stride + sid] + G1_5;
out[1*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 0*c_stride + sid] = c_alphaAPE * out[1*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 0*c_stride + sid] + G1_6;
out[1*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 1*c_stride + sid] = c_alphaAPE * out[1*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 1*c_stride + sid] + G1_7;
out[1*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 2*c_stride + sid] = c_alphaAPE * out[1*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 2*c_stride + sid] + G1_8;

////////////// mu = 2
READGAUGE(G1,gaugeTexAPE,2,sid,c_stride);
out[2*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 0*c_stride + sid] = c_alphaAPE * out[2*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 0*c_stride + sid] + G1_0;
out[2*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 1*c_stride + sid] = c_alphaAPE * out[2*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 1*c_stride + sid] + G1_1;
out[2*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 2*c_stride + sid] = c_alphaAPE * out[2*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 2*c_stride + sid] + G1_2;
out[2*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 0*c_stride + sid] = c_alphaAPE * out[2*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 0*c_stride + sid] + G1_3;
out[2*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 1*c_stride + sid] = c_alphaAPE * out[2*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 1*c_stride + sid] + G1_4;
out[2*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 2*c_stride + sid] = c_alphaAPE * out[2*c_nColor*c_nColor*c_stride + 1*c_nColor*c_stride + 2*c_stride + sid] + G1_5;
out[2*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 0*c_stride + sid] = c_alphaAPE * out[2*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 0*c_stride + sid] + G1_6;
out[2*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 1*c_stride + sid] = c_alphaAPE * out[2*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 1*c_stride + sid] + G1_7;
out[2*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 2*c_stride + sid] = c_alphaAPE * out[2*c_nColor*c_nColor*c_stride + 2*c_nColor*c_stride + 2*c_stride + sid] + G1_8;
