...
if(c_dimBreak[2] == true && (z_id == c_localL[2]-1)){
  ...
  READPROPGAUGE(GP,propagatorTexAPE,0,2,pointPlus[2],c_surface[2]);}
 else{
   READPROPGAUGE(GP,propagatorTexAPE,0,2,pointPlus[2],c_stride);}
/*
out[0*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 0*c_stride + sid].x += GP_0.x;
out[0*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 1*c_stride + sid].x += GP_1.x;
out[0*c_nColor*c_nColor*c_stride + 0*c_nColor*c_stride + 2*c_stride + sid].x += GP_2.x;
...
*/
/*
if(t_id == 0 && z_id == c_localL[2]-1 && y_id ==0 && x_id == 0){
  cuPrintf("%e %e\n",GP_0.x,GP_0.y);
  cuPrintf("%e %e\n",GP_1.x,GP_1.y);
  cuPrintf("%e %e\n",GP_2.x,GP_2.y);
  cuPrintf("%e %e\n",GP_3.x,GP_3.y);
