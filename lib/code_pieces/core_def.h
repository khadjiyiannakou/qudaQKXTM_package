...
#define READGAUGE(G,Tex,dir,idx,stride)				\
...
#define READVECTOR(S,Tex,idx,stride)			\
...
#define READPROPGAUGE(G,Tex,mu,nu,idx,stride)				\
...
#define DIRECTREADPROP(G,PROP,mu,nu,idx,stride)				\
